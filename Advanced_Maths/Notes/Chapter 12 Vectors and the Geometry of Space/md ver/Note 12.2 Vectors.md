...
If $\mathbf{v}$ is a ==two-dimensional== vector in the plane equal to the vector with initial point at the origin and terminal point $(v_{1},v_{2})$, then ==the component form== of $v$ is 
$$
\mathbf{v}=\langle v_{1},v_{2}\rangle
$$
$\mathbf{v}$ is a ==three-dimensional== vector in the plane equal to the vector with initial point at the origin and terminal point $(v_{1},v_{2},v_{3})$, then ==the component form== of $v$ is 
$$
\mathbf{v}=\langle v_{1},v_{2},v_{3}\rangle
$$
...
For the difference $\mathbf{u}-\mathbf{v}$, it is defined by 
$$
