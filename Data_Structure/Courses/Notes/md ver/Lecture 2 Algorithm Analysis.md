...
![[Data_Structure/Courses/Notes/figures/Figures of Lecture 2/Exercise 1 of lecture 2.png]]
The total amount is $1+2+2^{2}+\cdots+2^{n}=O(2^{n})$

![[Data_Structure/Courses/Notes/figures/Figures of Lecture 2/Exercise 2 of Lecture 2.png]]

Let $k = \log n$, then $T(n)=2^{k}T(1)+n\left( \log n+\log \frac{n}{2} +\cdots+\log1\right)=n+n(\log n)^{2}=O(n(\log n)^{2})$
![[Data_Structure/Courses/Notes/figures/Figures of Lecture 2/Exercise 3 of Lecture 2.png]]
