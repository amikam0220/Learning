...
int main()
{
    ...
    printf("=== Adjacency Matrix Performance ===\n");
...
void test_insert_edge_time(Graph *g, int n, int m)
{
    ...
    printf("Insert %d edges | Time: %lld ms | Structure: Adjacent matrix.\n",
...
size_t calc_graph_space(Graph *g)
{
    ...
    // array of vertices
    space += g->vexcapacity * sizeof(VexType);

    // space of matrix
    space += g->vexcapacity * g->vexcapacity * sizeof(int);
...
void test_space_occupation(Graph *g, int n, int m)
{
    printf("n=%d, m=%d | Matrix Space: %zu KB\n",
